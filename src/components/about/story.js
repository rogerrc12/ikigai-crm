...
import Business2 from "../../assets/images/resource/business-2.jpg";
        ...
        <div className="row clearfix">
          ...
          <div className="content-column col-lg-6 col-md-12 col-sm-12">
            <div className="inner-column">
              ...
              <div className="text">
                Ikigai CRM le permitirá a su equipo interactuar eficazmente con sus clientes y gestionar la relación con una
                visión integral de todos los procesos de ventas, marketing y soporte.
                <br />
                Nuestra solución se basa en las mejores prácticas de Vtiger CRM adaptadas para distintos tipos de negocios y
                customizada según sus necesidades específicas.
              </div>
