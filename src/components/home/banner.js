...
const banner = () => {
  return (
    <section className='banner-section'>
      <div className='patern-layer-one' style={{ backgroundImage: `url(${Pattern1})` }} />
      <div className='patern-layer-two' style={{ backgroundImage: `url(${Pattern2})` }} />
      <div className='patern-layer-three' style={{ backgroundImage: `url(${Pattern3})` }} />
      {/* Icons */}
      <div className='icons parallax-scene-1'>
        {/* Icon One */}
        <div data-depth='0.20' className='icon-one parallax-layer' style={{ backgroundImage: `url(${Icon1})` }} />
      </div>
